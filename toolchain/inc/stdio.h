...
long fflush(FILE *);
long fgetc(FILE *);
long fgetpos(FILE *_Restrict, fpos_t *_Restrict);
char *fgets(char *_Restrict, long, FILE *_Restrict);
...
long fprintf(FILE *_Restrict, const char *_Restrict, ...);
long fputc(long, FILE *);
long fputs(const char *_Restrict, FILE *_Restrict);
...
long fscanf(FILE *_Restrict , const char *_Restrict, ...);
long fseek(FILE *, long, long);
long fsetpos(FILE *, const fpos_t *);
long ftell(FILE *);
...
long printf(const char *_Restrict, ...);
...
long scanf(const char *_Restrict, ...);
void setbuf(FILE *_Restrict , char *_Restrict);
long setvbuf(FILE *_Restrict , char *_Restrict, long, size_t);
...
long sprintf(char *_Restrict, const char *_Restrict, ...);
...
long sscanf(const char *_Restrict, const char *_Restrict, ...);
FILE *tmpfile(void);
char *tmpnam(char *);
long ungetc(long, FILE *);
long vfprintf(FILE *_Restrict, const char *_Restrict, _Va_list);
long vprintf(const char *_Restrict, _Va_list);
long vsprintf(char *_Restrict, const char *_Restrict, _Va_list);
...
long _Flocale(FILE *, const char *, long);
void _Fsetlocale(FILE *, long);
long _Fspos(FILE *, const fpos_t *, long, long);
...
long snprintf(char *_Restrict, size_t,
	const char *_Restrict, ...);
long vsnprintf(char *_Restrict, size_t,
	const char *_Restrict, _Va_list);
long vfscanf(FILE *_Restrict,
	const char *_Restrict, _Va_list);
long vscanf(const char *_Restrict, _Va_list);
long vsscanf(const char *_Restrict,
	const char *_Restrict, _Va_list);
