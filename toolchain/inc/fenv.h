...
typedef unsigned long fenv_t;
  ...
  #define _FE_EXCEPT_OFF	26
  #define _FE_EXMASK_OFF	10
  #define _FE_RND_OFF		0

  #define _FE_AUTO_RAISE
  #define _FE_EXLAST_OFF	2
  #define _FE_EXMASK_ALL	0x100
...
long feclearexcept(long);
long fegetexceptflag(fexcept_t *, long);
long feraiseexcept(long);
long fesetexceptflag(const fexcept_t *, long);
long fetestexcept(long);
long fegetround(void);
long fesetround(long);
long fegetenv(fenv_t *);
long feholdexcept(fenv_t *);
long fesetenv(const fenv_t *);
long feupdateenv(const fenv_t *);
...
double _Force_raise(long except);
